...
import com.xcz.pojo.vo.PublisherVideo;
...
public class UserController extends BasicController {
	...
	public IMoocJSONResult uploadFace(String userId, 
		...
		// 文件保存的命名空间
		String fileSpace = "C:/Users/Frankie/Pictures/FrankieTV";
		//String fileSpace = "/usr/local/frankietv";
	...
	public IMoocJSONResult query(String userId, String fanId) throws Exception {
		...
		String userToken = redis.get(USER_REDIS_SESSION + ":" + userId);
